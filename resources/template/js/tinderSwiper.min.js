            ...
            $(document).on('mousedown touchstart', '.dzSwipe_card:not(.inactive)', function (s) {
                if (!o) {
                    ...
                    var i = s.pageX || s.originalEvent.touches[0].pageX,
                        l = s.pageY || s.originalEvent.touches[0].pageY;
                    ($(document).on('mousemove touchmove', function (s) {
                        var n = s.pageX || s.originalEvent.touches[0].pageX,
                            u = s.pageY || s.originalEvent.touches[0].pageY;
                        ((c = l - u),
                            ((d = n - i) || c) &&
                                (function () {
                                    ((o = !0), (r = d / 10), (degY = c / 10));
                                    var s = !1;
                        ...
                        $(document).on('mouseup touchend', function () {
                            ($(document).off('mousemove touchmove mouseup touchend'),
                                Math.abs(d) < Math.abs(c)
                                    ? (c >= n ? e.addClass('to-upside') : c <= -80 && e.addClass('to-downside'),
                                      Math.abs(c) >= n &&
                                          (e.addClass('inactive'),
                                          setTimeout(function () {
                                              (e.addClass('below').removeClass('inactive to-upside to-downside'), u());
                                          }, 300)),
                                    ...
                                    : Math.abs(d) > 0 &&
                                      (d >= n ? e.addClass('to-right') : d <= -80 && e.addClass('to-left'),
                                      Math.abs(d) >= n &&
                                          (e.addClass('inactive'),
                                          setTimeout(function () {
                                              (e.addClass('below').removeClass('inactive to-left to-right'), u());
                                          }, 300)),
            ...
            (l(),
                jQuery('.dz-sp-like').on('click', function () {
                    var e = jQuery(this).parents('.dzSwipe_card'),
                        t = e.find('.dzSwipe_card__option.dzSuperlike');
                    (t.css('opacity', '1'),
                        e.slideUp(300, function () {
                            (u(),
                                setTimeout(function () {
                                    (e.addClass('below').css('display', ''), t.css('opacity', ''));
                                }, 500));
                        }));
                }));
        },
