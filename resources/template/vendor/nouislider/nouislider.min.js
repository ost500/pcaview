...
!(function (t) {
    ...
    function w(t, e) {
        ...
        if (('lower' === e ? (e = [!0, !1]) : 'upper' === e && (e = [!1, !0]), !0 === e || !1 === e)) {
            ...
            if (!Array.isArray(e) || !e.length || e.length !== t.handles + 1)
                throw new Error('noUiSlider (' + et + "): 'connect' option doesn't match handle count.");
            n = e;
        }
        t.connect = n;
    }
    ...
    function y(t, e) {
        ...
        if (0 !== e && ((t.margin = t.spectrum.getMargin(e)), !t.margin))
            throw new Error('noUiSlider (' + et + "): 'margin' option is only supported on linear sliders.");
    }
    function E(t, e) {
        if (!i(e)) throw new Error('noUiSlider (' + et + "): 'limit' option must be numeric.");
        if (((t.limit = t.spectrum.getMargin(e)), !t.limit || t.handles < 2))
            throw new Error('noUiSlider (' + et + "): 'limit' option is only supported on linear sliders with 2 or more handles.");
    }
    function C(t, e) {
        ...
        if (Array.isArray(e) && 2 !== e.length && !i(e[0]) && !i(e[1]))
            throw new Error('noUiSlider (' + et + "): 'padding' option must be numeric or array of exactly 2 numbers.");
        if (0 !== e) {
            if (
                (Array.isArray(e) || (e = [e, e]),
                !(t.padding = [t.spectrum.getMargin(e[0]), t.spectrum.getMargin(e[1])]) === t.padding[0] || !1 === t.padding[1])
            )
                throw new Error('noUiSlider (' + et + "): 'padding' option is only supported on linear sliders.");
        ...
        if (!1 !== e)
            if (!0 === e) {
                ...
                if (((t.tooltips = ot(e)), t.tooltips.length !== t.handles))
                    throw new Error('noUiSlider (' + et + '): must pass a formatter for all handles.');
                t.tooltips.forEach(function (t) {
                    if ('boolean' != typeof t && ('object' != typeof t || 'function' != typeof t.to))
                        throw new Error('noUiSlider (' + et + "): 'tooltips' must be passed a formatter or 'false'.");
                });
            }
    }
    function P(t, e) {
    ...
    function z(t, f, o) {
        ...
        function O(e, i, o) {
            ...
            return (
                ...
                at(a, 0 === f.ort ? f.cssClasses.pipsHorizontal : f.cssClasses.pipsVertical),
        ...
        function R(t, e) {
            (e.handle && (st(e.handle, f.cssClasses.active), (v -= 1)),
                ...
                0 === v && (st(y, f.cssClasses.drag), J(), t.cursor && ((C.style.cursor = ''), C.removeEventListener('selectstart', rt))),
        ...
        function q(t, e) {
            ...
            var i = [],
                ...
                a = F(d.end, x, R, { target: t.target, handle: r, listeners: i, doNotReject: !0, handleNumbers: e.handleNumbers }),
                s = F('mouseout', x, D, { target: t.target, handle: r, listeners: i, doNotReject: !0, handleNumbers: e.handleNumbers });
        ...
        function I(t, e, r, n, i, o) {
            return (
                1 < u.length &&
                    ...
                    (n && 0 < e && (r = Math.max(r, t[e - 1] + f.margin)), i && e < u.length - 1 && (r = Math.min(r, t[e + 1] - f.margin))),
                1 < u.length &&
                    f.limit &&
                    (n && 0 < e && (r = Math.min(r, t[e - 1] + f.limit)), i && e < u.length - 1 && (r = Math.max(r, t[e + 1] - f.limit))),
            ...
            ((e = void 0 === e || !!e),
                ...
                g.forEach(function (t) {
                    ...
                    K(
                        ...
                        null === e || !1 === e || void 0 === e
                            ? m[r]
                            : ('number' == typeof e && (e = String(e)), (e = f.format.from(e)), !1 === (e = E.toStepping(e)) || isNaN(e) ? m[r] : e)),
                        !0,
                        !1,
                    );
                }),
        ...
        return (
            ...
            0 === f.ort ? at(e, f.cssClasses.horizontal) : at(e, f.cssClasses.vertical),
            ...
            (function (t, e) {
                ...
                for (var a = 0; a < f.handles; a++)
                    (u.push(
                        ...
                        i.setAttribute('aria-orientation', f.ort ? 'vertical' : 'horizontal'),
                        0 === r ? at(i, f.cssClasses.handleLower) : r === f.handles - 1 && at(i, f.cssClasses.handleUpper),
                        n),
                    ),
                        (g[a] = a),
                        s.push(V(o, t[a + 1])));
