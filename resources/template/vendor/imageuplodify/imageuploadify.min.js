(function ($, window, document, undefined) {
    ...
    $.fn.imageuploadify = function (opts) {
        ...
        this.each(function () {
            ...
            let counter = 0;
            let dragbox = $(
                `<div class="imageuploadify well style-2"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class="fa fa-cloud-upload"></i><span class='imageuploadify-message'>Upload File +</span><button type="button"class="btn btn-default">Upload File +</button></div></div>`,
            );
            ...
            const readingFile = (id, file) => {
                ...
                let container = $(
                    `<div class='imageuploadify-container'><button type='button'class='btn btn-danger fa fa-close'></button><div class='imageuploadify-details'><span>${file.name}</span><span>${file.type}</span><span>${file.size}</span></div></div>`,
                );
