    ...
    $.jstree.core.prototype = {
        ...
        activate_node: function (obj, e) {
            ...
            if (
                ...
                (e.shiftKey &&
                    (!this._data.core.last_clicked || !this.get_parent(obj) || this.get_parent(obj) !== this._data.core.last_clicked.parent))
            ) {
                ...
                if (data && data.data && data.data.jstree) {
                    if (e.type === 'keyup' && e.which === 27) {
                        ...
                        data.helper
                            ...
                            [
                                data.data.origin &&
                                (data.data.origin.settings.dnd.always_copy || (data.data.origin.settings.dnd.copy && (e.metaKey || e.ctrlKey)))
                                    ? 'show'
                                    : 'hide'
                            ]();
                        if (lastev) {
