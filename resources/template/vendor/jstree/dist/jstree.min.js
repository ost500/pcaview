            ...
            (a.jstree.core.prototype = {
                ...
                bind: function () {
                    ...
                    this.element
                        ...
                        .on(
                            ...
                            function (b) {
                                (b.preventDefault(),
                                    b.currentTarget !== i.activeElement && a(b.currentTarget).trigger('focus'),
                            ...
                            k = function (b, c) {
                                if (null !== this.element) {
                                    ...
                                    if (((this._model.data = b.mod), c)) {
                                        ...
                                        if (
                                            ((f = this._model.data), k.length !== l.length || a.vakata.array_unique(k.concat(l)).length !== k.length)
                                        ) {
                ...
                get_json: function (b, c, d) {
                    ...
                    if (
                        ...
                        c &&
                            c.no_id &&
                            (delete e.id, e.li_attr && e.li_attr.id && delete e.li_attr.id, e.a_attr && e.a_attr.id && delete e.a_attr.id),
                        ...
                        -1 !== a.inArray(this._data.core.focused, g) &&
                            ...
                            e.id === a.jstree.root
                                ? this._model.data[a.jstree.root].children[0] &&
                                  this.get_node(this._model.data[a.jstree.root].children[0], !0).children('.jstree-anchor').triger('focus')
                              ...
                              (l = a('<input />', {
                                  ...
                                  blur: function (c) {
                                      ...
                                      ('' === f && (f = j),
                                          ...
                                          (m = !!this.rename_node(
                                              b,
                                              i ? a('<div></div>').text(f).text() : a('<div></div>').append(a.parseHTML(f)).html(),
                                          )),
                                          m || this.set_text(b, j),
                                          (this._data.core.focused = n.id),
                                          setTimeout(
                                        ...
                                        if (c.state.loaded) {
                                            for (d = 0, e = c.children_d.length; e > d; d++)
                                                if (
                                                    ...
                                                    for (
                                                        h[j.id] === b && j.id !== a.jstree.root && ((h[j.id] = !0), l.push(j.id)),
                                                            f = 0,
                                                            g = j.parents.length;
                                                        g > f;
                                                        f++
                                            ...
                                            for (
                                                h[c.id] === b && c.id !== a.jstree.root && ((h[c.id] = !0), l.push(c.id)),
                                                    f = 0,
                                                    g = c.parents.length;
                                                g > f;
                                                f++
                            ...
                            b && b.id !== a.jstree.root
                                ? ((e = this.get_node(b, !0)),
                                  void (
                                      ...
                                      e &&
                                          e.length &&
                                          e.children('.jstree-anchor').children('.jstree-checkbox').removeClass('jstree-checkbox-disabled'),
                ...
                ((a.vakata.context = {
                    ...
                    _execute: function (b) {
                        return (
                            ...
                            b &&
                            (!b._disabled ||
                                (a.vakata.is_function(b._disabled) && !b._disabled({ item: b, reference: c.reference, element: c.element }))) &&
                            b.action
                                ? b.action.call(null, {
                                      item: b,
                                      reference: c.reference,
                                    ...
                                    ? (c.items.push(d),
                                      !f &&
                                          ...
                                          (e +=
                                              ...
                                              (a.vakata.context.settings.icons ? '' : 'class="vakata-context-no-icons"') +
                                              '>&#160;</a></li>'),
                                      (f = !1),
                                      (e +=
                                          "<li class='" +
                                          (d._class || '') +
                                          (d._disabled === !0 ||
                                          (a.vakata.is_function(d._disabled) && d._disabled({ item: d, reference: c.reference, element: c.element }))
                    ...
                    show: function (d, e, f) {
                        ...
                        (d && !f && a(d).data('vakata_contextmenu') && (f = a(d).data('vakata_contextmenu')),
                            ...
                            c.items.length &&
                                ...
                                b &&
                                    ((j -= h.outerWidth() - a(d).outerWidth()), j < a(window).scrollLeft() + 20 && (j = a(window).scrollLeft() + 20)),
                                j + l + 20 > n && (j = n - (l + 20)),
                                k + m + 20 > o && (k = o - (m + 20)),
                                c.element
                                    .css({ left: j, top: k })
                    ...
                    hide: function () {
                        c.is_visible &&
                            (c.element.hide().find('ul').hide().end().find(':focus').trigger('blur').end().detach(),
                            (c.is_visible = !1),
                        ...
                        ((c.element = a("<ul class='vakata-context'></ul>")),
                            c.element
                                ...
                                .on('mouseleave', 'li', function (b) {
                                    a.contains(this, b.relatedTarget) ||
                                        a(this).find('.vakata-context-hover').addBack().removeClass('vakata-context-hover');
                                })
                                ...
                                .on('click', 'a', function (b) {
                                    (b.preventDefault(),
                                        a(this).trigger('blur').parent().hasClass('vakata-context-disabled') ||
                            ...
                            if (c) {
                                ...
                                c.ins[
                                    ...
                                    (h.data.origin.settings.dnd.always_copy ||
                                        (h.data.origin.settings.dnd.copy && (h.event.metaKey || h.event.ctrlKey)))
                                        ? 'copy_node'
                                        : 'move_node'
                                ...
                                if (
                                    !(
                                        Math.abs(b.pageX - c.init_x) >
                                            (c.is_touch ? a.vakata.dnd.settings.threshold_touch : a.vakata.dnd.settings.threshold) ||
                                        ...
                                        for (k in g[j].li_attr)
                                            if (g[j].li_attr.hasOwnProperty(k)) {
                                                ...
                                                e[f[h]].li_attr[k] === b
                                                    ...
                                                    : 'class' === k &&
                                                      (e[f[h]].li_attr['class'] = g[j].li_attr['class'] + ' ' + e[f[h]].li_attr['class']);
                                            }
                                            ...
                                            if (g[j].a_attr.hasOwnProperty(k)) {
                                                ...
                                                e[f[h]].a_attr[k] === b
                                                    ...
                                                    : 'href' === k && '#' === e[f[h]].a_attr[k]
                                                      ...
                                                      : 'class' === k &&
                                                        (e[f[h]].a_attr['class'] = g[j].a_attr['class'] + ' ' + e[f[h]].a_attr['class']);
                                            }
                                }
                            ...
                            for (k in f[d].li_attr)
                                if (f[d].li_attr.hasOwnProperty(k)) {
                                    ...
                                    e[c.id].li_attr[k] === b
                                        ...
                                        : 'class' === k &&
                                          ((e[c.id].li_attr['class'] = f[d].li_attr[k] + ' ' + e[c.id].li_attr['class']),
                                ...
                                if (f[d].a_attr.hasOwnProperty(k)) {
                                    ...
                                    e[c.id].a_attr[k] === b
                                        ? ((e[c.id].a_attr[k] = f[d].a_attr[k]),
                                          m && ('class' === k ? m.addClass(f[d].a_attr[k]) : m.attr(k, f[d].a_attr[k])))
                                        : 'href' === k && '#' === e[c.id].a_attr[k]
                                          ? ((e[c.id].a_attr.href = f[d].a_attr.href), m && m.attr('href', f[d].a_attr.href))
                                          : 'class' === k &&
                                            ((e[c.id].a_attr['class'] = f[d].a_attr['class'] + ' ' + e[c.id].a_attr['class']),
