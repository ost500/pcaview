!(function (e) {
    ...
    var c = (function () {
        ...
        d = (function () {
            function z(e, t) {
                ...
                if (
                    (u(this, z),
                    ((n = a(this, l(z).call(this))).element = e),
                    (n.version = z.version),
                ...
                if (((n.options = z.extend({}, n.defaultOptions, o, null != t ? t : {})), n.options.forceFallback || !z.isBrowserSupported()))
                    return a(n, n.options.fallback.call(s(n)));
                ...
                return (
                    ...
                    !1 !== n.options.previewsContainer &&
                        (n.options.previewsContainer
                            ? (n.previewsContainer = z.getElement(n.options.previewsContainer, 'previewsContainer'))
                            : (n.previewsContainer = n.element)),
                    n.options.clickable &&
                        (!0 === n.options.clickable
                            ? (n.clickableElements = [n.element])
                            : (n.clickableElements = z.getElements(n.options.clickable, 'clickable'))),
                    n.init(),
                    n
                );
            }
                            ...
                            ((this.prototype.Emitter = c),
                                ...
                                (this.prototype.defaultOptions = {
                                    ...
                                    fallback: function () {
                                        ...
                                        try {
                                            for (
                                                var r, o = this.element.getElementsByTagName('div')[Symbol.iterator]();
                                                !(t = (r = o.next()).done);
                                                t = !0
                                            ) {
                                                var a = r.value;
                                    ...
                                    resize: function (e, t, n, i) {
                                        ...
                                        if (r.srcWidth > t || r.srcHeight > n)
                                            if ('crop' === i)
                                                a < o
                                                    ? ((r.srcHeight = e.height), (r.srcWidth = r.srcHeight * a))
                                                    : ((r.srcWidth = e.width), (r.srcHeight = r.srcWidth / a));
                                            else {
                                    ...
                                    addedfile: function (t) {
                                        ...
                                        if (
                                            ...
                                            ((t.previewElement = z.createElement(this.options.previewTemplate.trim())),
                                            ...
                                            try {
                                                for (
                                                    var o, a = t.previewElement.querySelectorAll('[data-dz-name]')[Symbol.iterator]();
                                                    !(e = (o = a.next()).done);
                                                    e = !0
                                                ) {
                                                    var l = o.value;
                                            ...
                                            try {
                                                for (
                                                    var d, h = t.previewElement.querySelectorAll('[data-dz-size]')[Symbol.iterator]();
                                                    !(s = (d = h.next()).done);
                                                    s = !0
                                                )
                                            ...
                                            function p(e) {
                                                return (
                                                    e.preventDefault(),
                                                    e.stopPropagation(),
                                                    t.status === z.UPLOADING
                                                        ? z.confirm(n.options.dictCancelUploadConfirmation, function () {
                                                              return n.removeFile(t);
                                                          })
                                                        : n.options.dictRemoveFileConfirmation
                                                          ? z.confirm(n.options.dictRemoveFileConfirmation, function () {
                                                                return n.removeFile(t);
                                                            })
                                                          : n.removeFile(t)
                                                );
                                            ...
                                            try {
                                                for (
                                                    var y, g = t.previewElement.querySelectorAll('[data-dz-remove]')[Symbol.iterator]();
                                                    !(f = (y = g.next()).done);
                                                    f = !0
                                                ) {
                                                    y.value.addEventListener('click', p);
                                                }
                                            } catch (e) {
                                                ((v = !0), (m = e));
                                            } finally {
                                    ...
                                    thumbnail: function (e, t) {
                                        if (e.previewElement) {
                                            ...
                                            try {
                                                for (
                                                    var o, a = e.previewElement.querySelectorAll('[data-dz-thumbnail]')[Symbol.iterator]();
                                                    !(n = (o = a.next()).done);
                                                    n = !0
                                                ) {
                                                    var l = o.value;
                                    ...
                                    error: function (e, t) {
                                        if (e.previewElement) {
                                            ...
                                            try {
                                                for (
                                                    var o, a = e.previewElement.querySelectorAll('[data-dz-errormessage]')[Symbol.iterator]();
                                                    !(n = (o = a.next()).done);
                                                    n = !0
                                                ) {
                                    ...
                                    uploadprogress: function (e, t) {
                                        if (e.previewElement) {
                                            ...
                                            try {
                                                for (
                                                    var o, a = e.previewElement.querySelectorAll('[data-dz-uploadprogress]')[Symbol.iterator]();
                                                    !(n = (o = a.next()).done);
                                                    n = !0
                                                ) {
                                                    var l = o.value;
                ...
                o(
                    ...
                    [
                                ...
                                if (
                                    ...
                                    !(function l() {
                                        return (
                                            ...
                                            z.getElement(s.options.hiddenInputContainer, 'hiddenInputContainer').appendChild(s.hiddenFileInput),
                                            ...
                                            events: {
                                                click: function (e) {
                                                    return (
                                                        (t === s.element &&
                                                            e.target !== s.element &&
                                                            !z.elementInside(e.target, s.element.querySelector('.dz-message'))) ||
                        ...
                        },
                        {
                            ...
                            value: function () {
                                return (
                                    ...
                                    z.instances.splice(z.instances.indexOf(this), 1)
                                );
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function (e, t) {
                                this.options.maxFilesize && e.size > 1024 * this.options.maxFilesize * 1024
                                    ...
                                    : z.isValidFile(e, this.options.acceptedFiles)
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                var n = this;
                                ((t.upload = { uuid: z.uuidv4(), progress: 0, total: t.size, bytesSent: 0, filename: this._renameFile(t) }),
                                    this.files.push(t),
                                    (t.status = z.ADDED),
                                    ...
                                    this.accept(t, function (e) {
                                        (e
                                            ...
                                            : ((t.accepted = !0), n.options.autoQueue && n.enqueueFile(t)),
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                var t = this;
                                if (e.status !== z.ADDED || !0 !== e.accepted)
                                    throw new Error("This file can't be queued because it has already been processed or was rejected.");
                                if (((e.status = z.QUEUED), this.options.autoProcessQueue))
                                    return setTimeout(function () {
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                if (
                                    (e.status === z.UPLOADING && this.cancelUpload(e),
                                    (this.files = h(this.files, e)),
                                        ...
                                        return (
                                            ...
                                            e(function (e) {
                                                ...
                                                switch (
                                                    ...
                                                    4 < e && ((n.width = t.trgHeight), (n.height = t.trgWidth)),
                                                    e)
                                                ) {
                                                    case 2:
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                if (e.status === z.UPLOADING) {
                                    ...
                                    (e.status !== z.ADDED && e.status !== z.QUEUED) ||
                                        ((e.status = z.CANCELED),
                                ...
                                this._transformFiles(s, function (e) {
                                    ...
                                    if (s[0].upload.chunked) {
                                        ...
                                        for (var a = [], l = 0; l < s.length; l++)
                                            a[l] = { name: u._getParamName(l), data: e[l], filename: s[l].upload.filename };
                                        u._uploadData(s, a);
                                    }
                                });
                            },
                            ...
                            value: function (t, e) {
                                ...
                                if (this.options.params) {
                                    ...
                                    for (var m in ('function' == typeof v &&
                                        (v = v.call(this, t, i, t[0].upload.chunked ? this._getChunk(t[0], i) : null)),
                                    v)) {
                                        var y = v[m];
                                        f.append(m, y);
                                    }
                        ...
                        },
                        {
                            ...
                            value: function (n, i) {
                                ...
                                for (var r = this, o = [], a = 0, t = 0; t < n.length; t++) e(t);
                            },
                        },
                        {
                            ...
                            value: function (e) {
                                if ('FORM' === this.element.tagName) {
                                    ...
                                    try {
                                        for (
                                            var r, o = this.element.querySelectorAll('input, textarea, select, button')[Symbol.iterator]();
                                            !(t = (r = o.next()).done);
                                            t = !0
                                        ) {
                                            var a = r.value,
                                ...
                                if (void 0 !== n) {
                                    ...
                                    try {
                                        for (var x, E = e[Symbol.iterator](); !(k = (x = E.next()).done); k = !0) {
                                            var C = x.value;
                                            ((100 === C.upload.progress && C.upload.bytesSent === C.upload.total) || (b = !1),
                                                (C.upload.progress = i),
                        ...
                        },
                        {
                            ...
                            value: function (e, t, n) {
                                ...
                                if (
                                    (this.options.uploadMultiple && (this.emit('successmultiple', e, t, n), this.emit('completemultiple', e)),
                        ...
                        },
                        {
                            ...
                            value: function (e, t, n) {
                                ...
                                if (
                                    (this.options.uploadMultiple && (this.emit('errormultiple', e, t, n), this.emit('completemultiple', e)),
                                    this.options.autoProcessQueue)
                                )
                                    return this.processQueue();
                            },
    ...
    (d.initClass(),
        ...
        (d.blacklistedBrowsers = [/opera.*(Macintosh|Windows Phone).*version\/12/i]),
    ...
    ((d.createElement = function (e) {
        ...
        (d.getElements = function (e, t) {
            ...
            if (e instanceof Array) {
                ...
                var u = !0,
                    ...
                    d = void 0;
                try {
                    for (var h, p = document.querySelectorAll(e)[Symbol.iterator](); !(u = (h = p.next()).done); u = !0) ((n = h.value), i.push(n));
                } catch (e) {
                    ((c = !0), (d = e));
                } finally {
                    try {
        ...
        null != t ? (t.exports = d) : (window.Dropzone = d),
        (d.ADDED = 'added'),
        (d.QUEUED = 'queued'),
        (d.ACCEPTED = d.QUEUED),
        (d.UPLOADING = 'uploading'),
        (d.PROCESSING = d.UPLOADING),
        (d.CANCELED = 'canceled'),
        (d.ERROR = 'error'),
        (d.SUCCESS = 'success'));
    var f = function (e, t, n, i, r, o, a, l, s, u) {
            var c = (function (e) {
                e.naturalWidth;
    ...
    v.initClass();
    return (
        (d._autoDiscoverFunction = function () {
        ...
        })(window, d._autoDiscoverFunction),
        t.exports
    );
});
