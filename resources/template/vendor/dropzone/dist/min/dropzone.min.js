            ...
            return (
                ...
                n.options.clickable &&
                    (!0 === n.options.clickable
                        ...
                        : (n.clickableElements = C.getElements(n.options.clickable, 'clickable'))),
                n.init(),
                n
            );
        }
                        ...
                        ((this.prototype.Emitter = Emitter),
                            ...
                            (this.prototype.defaultOptions = {
                                ...
                                addedfile: function (t) {
                                    var n = this;
                                    if (
                                        (this.element === this.previewsContainer && this.element.classList.add('dz-started'), this.previewsContainer)
                                    ) {
                                        ...
                                        try {
                                            for (
                                                var d, p = t.previewElement.querySelectorAll('[data-dz-size]')[Symbol.iterator]();
                                                !(s = (d = p.next()).done);
                                                s = !0
                                            )
                                        ...
                                        events: {
                                            click: function (e) {
                                                return (
                                                    (t === s.element &&
                                                        e.target !== s.element &&
                                                        !C.elementInside(e.target, s.element.querySelector('.dz-message'))) ||
                                ...
                                if (s[0].upload.chunked) {
                                    ...
                                    var i = function () {
                                        ...
                                        if (!(e >= r.upload.totalChunkCount)) {
                                            ...
                                            ((r.upload.chunks[e] = { file: r, index: e, dataBlock: i, status: C.UPLOADING, progress: 0, retries: 0 }),
                                                u._uploadData(s, [i]));
                                        }
                                    };
                                    if (
