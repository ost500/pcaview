        ...
        return (
            ...
            p
                ? Object.assign(
                      ...
                      (R[j] = w ? '0' : ''),
                      (R.transform =
                          (k.devicePixelRatio || 1) <= 1 ? 'translate(' + y + 'px, ' + b + 'px)' : 'translate3d(' + y + 'px, ' + b + 'px, 0)'),
                      R),
                  )
                ...
                for (
                    var o = n.mainAxis,
                        ...
                        b = [v].concat(g).reduce(function (e, n) {
                            return e.concat(
                                F(n) === M
                                    ? ue(t, { placement: n, boundary: p, rootBoundary: u, padding: c, flipVariations: h, allowedAutoPlacements: m })
                                    : n,
                            );
                        }, []),
                        x = t.rects.reference,
