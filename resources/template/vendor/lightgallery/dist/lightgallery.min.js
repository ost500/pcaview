    ...
    var C = (function () {
        ...
        return (
            ...
            (t.prototype._getSelector = function (t, e) {
                return (
                    void 0 === e && (e = document),
                    'string' != typeof t ? t : ((e = e || document), '#' === t.substring(0, 1) ? e.querySelector(t) : e.querySelectorAll(t))
                );
            }),
            ...
            return (
                ...
                (w.prototype.resetScrollBar = function () {
                    this.shouldHideScrollbar() &&
                        (x(document.body).css('padding-right', this.bodyPaddingRight + 'px'), x(document.body).removeClass('lg-overlay-open'));
                }),
                (w.prototype.openGallery = function (t, e) {
                    ...
                    if ((void 0 === t && (t = this.settings.index), !this.lgOpened)) {
                        ...
                        (this.zoomFromOrigin &&
                            e &&
                            ((this.currentImageSize = T(e, this.outer, d + g, h && this.settings.videoMaxSize)),
                            (o = E(e, this.outer, d, g, this.currentImageSize))),
                            (this.zoomFromOrigin && o) ||
                                (this.outer.addClass(this.settings.startClass), this.getSlideItem(t).removeClass('lg-complete')));
                ...
                (w.prototype.getDummyImageContent = function (t, e, i) {
                    ...
                    if ((this.settings.dynamic || (s = x(this.items).eq(e)), s)) {
                        ...
                        var o =
                            '<img ' + i + ' style="' + this.getDummyImgStyles(this.currentImageSize) + '" class="lg-dummy-img" src="' + n + '" />';
                ...
                (w.prototype.setImgMarkup = function (t, e, i) {
                    var s = this.galleryItems[i],
                        ...
                        d =
                            ...
                            (this.isFirstSlideWithZoomAnimation() ? this.getDummyImageContent(e, i, a) : D(i, t, a, o, r, l)) +
                            '</picture>';
                    e.prepend(d);
                }),
                ...
                (w.prototype.loadContent = function (t, i) {
                    ...
                    if (
                        ...
                        ((l || p) && this.LGel.trigger(s, { index: t, src: h, html5Video: u, hasPoster: !!l }),
                    ...
                    (b && !x(document.body).hasClass('lg-from-hash') && (k = b),
                        ...
                        (this.isFirstSlideWithZoomAnimation() && ('video' !== this.getSlideType(o) || l)) ||
                        ...
                        if (!this.lgBusy) {
                            ...
                            if (
                                ...
                                var y = void 0,
                                    v = void 0;
                                (r > 2
                                    ? ((y = t - 1), (v = t + 1), ((0 === t && o === r - 1) || (t === r - 1 && 0 === o)) && ((v = 0), (y = r - 1)))
                                    : ((y = 0), (v = 1)),
                                ...
                                setTimeout(
                                    function () {
                                        ((n.lgBusy = !1),
                                            ...
                                            n.LGel.trigger(h, { prevIndex: o, index: t, fromTouch: e, fromThumb: i }));
                                    },
                        ...
                        setTimeout(function () {
                            ...
                            if ('horizontal' === n.swipeDirection) {
                                ...
                                s < 0 && r > n.settings.swipeThreshold
                                    ...
                                    : s > 0 && r > n.settings.swipeThreshold && (n.goToPrevSlide(!0), (o = !1));
                            } else if ('vertical' === n.swipeDirection) {
                                if (((s = Math.abs(t.pageY - e.pageY)), n.settings.closable && n.settings.swipeToClose && s > 100))
                    ...
                    this.settings.enableSwipe &&
                        (this.$inner.on('touchstart.lg', function (i) {
                            ...
                            (!x(i.target).hasClass('lg-item') && !s.get().contains(i.target)) ||
                                ...
                                (t.touchAction = 'swipe'),
                                t.manageSwipeClass(),
                                (e = { pageX: i.targetTouches[0].pageX, pageY: i.targetTouches[0].pageY }));
                        }),
                        this.$inner.on('touchmove.lg', function (o) {
                            n &&
                                'swipe' === t.touchAction &&
                                1 === o.targetTouches.length &&
                                ((i = { pageX: o.targetTouches[0].pageX, pageY: o.targetTouches[0].pageY }), t.touchMove(e, i, o), (s = !0));
                        }),
                ...
                (w.prototype.enableDrag = function () {
                    ...
                    this.settings.enableDrag &&
                        ...
                        x(window).on('mouseup.lg.global' + this.lgId, function (o) {
                            if (t.lgOpened) {
                                var r = x(o.target);
                                (n ? ((n = !1), t.touchEnd(i, e, o), t.LGel.trigger(p)) : t.isPosterElement(r) && t.LGel.trigger(c),
                ...
                (w.prototype.manageSwipeClass = function () {
                    ...
                    (this.settings.loop &&
                        ...
                        (0 === this.index ? (e = this.galleryItems.length - 1) : this.index === this.galleryItems.length - 1 && (t = 0)),
                ...
                (w.prototype.keyPress = function () {
                    ...
                    x(window).on('keydown.lg.global' + this.lgId, function (e) {
                        (t.lgOpened &&
                            ...
                            27 === e.keyCode &&
                            (e.preventDefault(),
                            t.settings.allowMediaOverlap && t.outer.hasClass('lg-can-toggle') && t.outer.hasClass('lg-components-open')
                        ...
                        x(window).on('keydown.lg.global' + this.lgId, function (e) {
                            if (t.lgOpened && ('Tab' === e.key || 9 === e.keyCode)) {
                                var i = G(t.$container.get()),
                                    ...
                                    n = i[i.length - 1];
                                e.shiftKey
                                    ? document.activeElement === s && (n.focus(), e.preventDefault())
                                    : document.activeElement === n && (s.focus(), e.preventDefault());
                            }
                        }));
                }),
