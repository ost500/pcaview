...
!(function (t, e) {
    'object' == typeof exports && 'undefined' != typeof module
        ...
        : 'function' == typeof define && define.amd
          ? define(e)
          : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).lgShare = e());
})(this, function () {
    'use strict';
    var t = function () {
        return (t =
    ...
    function e() {
        ...
        var o = Array(t),
            n = 0;
        for (e = 0; e < r; e++) for (var i = arguments[e], s = 0, a = i.length; s < a; s++, n++) o[n] = i[s];
        return o;
    }
    var r = {
        share: !0,
    ...
    function i(t) {
        ...
        return (
            ...
            encodeURIComponent(t.pinterestShareUrl || window.location.href) +
            '&media=' +
            r +
            '&description=' +
            e
    ...
    return (function () {
        ...
        return (
            (a.prototype.init = function () {
                this.settings.share &&
                    ((this.shareOptions = e(this.getDefaultShareOptions(), this.settings.additionalShareOptions)),
                    this.setLgShareMarkup(),
                    this.core.outer.find('.lg-share .lg-dropdown').append(this.getShareListHtml()),
                    this.core.LGel.on(s + '.share', this.onAfterSlide.bind(this)));
            }),
            (a.prototype.getShareListHtml = function () {
                var t = '';
                return (
                    this.shareOptions.forEach(function (e) {
                        t += e.dropdownHTML;
                    }),
                    t
                );
                    ...
                    this.core.outer
                        ...
                        .on('click.lg', function () {
                            (t.core.outer.toggleClass('lg-dropdown-active'),
                                t.core.outer.hasClass('lg-dropdown-active')
                                    ? t.core.outer.attr('aria-expanded', !0)
                                    : t.core.outer.attr('aria-expanded', !1));
                        }),
                    this.core.outer
