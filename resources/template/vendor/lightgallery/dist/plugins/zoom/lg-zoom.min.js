...
!(function (t, e) {
    'object' == typeof exports && 'undefined' != typeof module
        ...
        : 'function' == typeof define && define.amd
          ? define(e)
          : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).lgZoom = e());
})(this, function () {
    'use strict';
    var t = function () {
            return (t =
            ...
            (h.prototype.enableZoom = function (t) {
                ...
                (this.$LG('body').first().hasClass('lg-from-hash') && t.detail.delay ? (o = 0) : this.$LG('body').first().removeClass('lg-from-hash'),
                    (this.zoomableTimeout = setTimeout(function () {
                        e.isImageSlide() &&
                            (e.core.getSlideItem(t.detail.index).addClass('lg-zoomable'), t.detail.index === e.core.index && e.setZoomEssentials());
                    }, o + 30)));
            }),
                    ...
                    (this.core.outer.on('dblclick.lg', function (e) {
                        ...
                        this.core.getElementById('lg-zoom-out').on('click.lg', function () {
                            t.core.outer.find('.lg-current .lg-image').get() &&
                                ((t.scale -= t.settings.scale), (t.scale = t.getScale(t.scale)), t.beginZoom(t.scale), t.zoomImage(t.scale));
                        }),
