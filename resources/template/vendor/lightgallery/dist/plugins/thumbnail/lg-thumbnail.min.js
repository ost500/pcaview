...
!(function (t, e) {
    'object' == typeof exports && 'undefined' != typeof module
        ...
        : 'function' == typeof define && define.amd
          ? define(e)
          : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).lgThumbnail = e());
})(this, function () {
    'use strict';
    var t = function () {
            return (t =
        ...
        return (
            ...
            (o.prototype.enableThumbSwipe = function () {
                ...
                (this.$lgThumb.on('touchstart.lg', function (i) {
                    t.thumbTotalWidth > t.thumbOuterWidth &&
                        (i.preventDefault(), (e.cords.startX = i.targetTouches[0].pageX), (t.thumbClickable = !1), (e.startTime = new Date()));
                }),
                    this.$lgThumb.on('touchmove.lg', function (i) {
                        t.thumbTotalWidth > t.thumbOuterWidth &&
                            (i.preventDefault(), (e.cords.endX = i.targetTouches[0].pageX), (e = t.onThumbTouchMove(e)));
                    }),
                ...
                return (
                    (i =
                        s.youtube && this.settings.loadYouTubeThumbnail
                            ? '//img.youtube.com/vi/' + s.youtube[1] + '/' + this.settings.youTubeThumbSize + '.jpg'
                            : t),
                    '<div data-lg-item-id="' +
                        e +
                        '" class="lg-thumb-item ' +
            ...
            (o.prototype.thumbKeyPress = function () {
                ...
                this.$LG(window).on('keydown.lg.thumb.global' + this.core.lgId, function (e) {
                    t.core.lgOpened &&
                        ...
                        (38 === e.keyCode
                            ? (e.preventDefault(), t.core.outer.addClass('lg-components-open'))
