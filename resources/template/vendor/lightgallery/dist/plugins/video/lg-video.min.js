        ...
        return (
            ...
            (d.prototype.onSlideItemLoad = function (e) {
                ...
                (this.settings.autoplayFirstVideo &&
                    ...
                    !t && this.settings.autoplayVideoOnSlide && s === this.core.index && this.loadAndPlayVideo(s));
            }),
            (d.prototype.onHasVideo = function (e) {
                var o = e.detail,
                    ...
                    s = o.html5Video;
                o.hasPoster ||
                    (this.appendVideos(this.core.getSlideItem(i), { src: t, addClass: 'lg-object', index: i, html5Video: s }),
                ...
                if (n.youtube) {
                    var c = 'lg-youtube' + i,
                        u =
                            ...
                            (this.settings.youTubePlayerParams ? '&' + r(this.settings.youTubePlayerParams) : '');
                    s =
                    ...
                    ((c = 'lg-vimeo' + i),
                        (u = (function (e, o) {
                            ...
                            return (
                                n && (i = i.replace('/' + s, '')),
                                '?autoplay=0&muted=1' + (n ? '&h=' + s : '') + t + ('?' == i[0] ? '&' + i.slice(1) : i || '')
                            );
                    ...
                    var h = 'lg-wistia' + i;
                    ((u = (u = r(this.settings.wistiaPlayerParams)) ? '?' + u : ''),
                        (s =
                            '<iframe allow="autoplay" id="' +
                            h +
            ...
            (d.prototype.appendVideos = function (e, o) {
                ...
                if (
                    ...
                    this.settings.videojs && (null === (i = this.core.galleryItems[o.index].__slideVideoInfo) || void 0 === i ? void 0 : i.html5))
                )
                    try {
            ...
            (d.prototype.loadVideoOnPosterClick = function (e, o) {
                ...
                if (e.hasClass('lg-video-loaded')) o && this.playVideo(this.core.index);
                    ...
                    var l = this.appendVideos(e, { src: s, addClass: '', index: this.core.index, html5Video: t });
