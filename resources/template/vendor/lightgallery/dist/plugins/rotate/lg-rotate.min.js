...
!(function (t, e) {
    'object' == typeof exports && 'undefined' != typeof module
        ...
        : 'function' == typeof define && define.amd
          ? define(e)
          : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).lgRotate = e());
})(this, function () {
    'use strict';
    var t = function () {
            return (t =
    ...
    return (function () {
        function n(e, i) {
            return ((this.core = e), (this.$LG = i), (this.settings = t(t({}, l), this.core.settings)), this);
        }
        return (
            ...
            (n.prototype.init = function () {
                ...
                this.settings.rotate &&
                    ...
                    this.core.LGel.on(e + '.rotate', function (e) {
                        ...
                        (t.core.getSlideItem(i).find('.lg-img-wrap').first().wrap('lg-img-rotate'),
                            t.core
                    ...
                    this.core.LGel.on(i + '.rotate', function (e) {
                        t.rotateValuesList[e.detail.index] ||
                            (t.rotateValuesList[e.detail.index] = { rotate: 0, flipHorizontal: 1, flipVertical: 1 });
                    }));
            }),
            ...
            (n.prototype.rotateLeft = function () {
                ((this.rotateValuesList[this.core.index].rotate -= 90),
                    this.applyStyles(),
                    this.triggerEvents(r, { rotate: this.rotateValuesList[this.core.index].rotate }));
            }),
            (n.prototype.rotateRight = function () {
                ((this.rotateValuesList[this.core.index].rotate += 90),
                    this.applyStyles(),
                    this.triggerEvents(o, { rotate: this.rotateValuesList[this.core.index].rotate }));
            }),
            (n.prototype.getCurrentRotation = function (t) {
                ...
                if ('none' !== i) {
                    ...
                    if (r) {
                        var o = Math.round(Math.atan2(r[1], r[0]) * (180 / Math.PI));
                        return o < 0 ? o + 360 : o;
                    }
                }
                return 0;
            ...
            (n.prototype.flipHorizontal = function () {
                var t = this.core.getSlideItem(this.core.index).find('.lg-img-rotate').first().get(),
                    e = this.getCurrentRotation(t),
                    i = 'flipHorizontal';
                ((90 !== e && 270 !== e) || (i = 'flipVertical'),
                    (this.rotateValuesList[this.core.index][i] *= -1),
                    this.applyStyles(),
                    this.triggerEvents(s, { flipHorizontal: this.rotateValuesList[this.core.index][i] }));
            }),
            (n.prototype.flipVertical = function () {
                ...
                ((90 !== e && 270 !== e) || (i = 'flipHorizontal'),
                    (this.rotateValuesList[this.core.index][i] *= -1),
                    this.applyStyles(),
                    this.triggerEvents(a, { flipVertical: this.rotateValuesList[this.core.index][i] }));
            }),
