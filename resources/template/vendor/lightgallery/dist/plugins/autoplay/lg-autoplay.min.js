...
!(function (t, o) {
    'object' == typeof exports && 'undefined' != typeof module
        ...
        : 'function' == typeof define && define.amd
          ? define(o)
          : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).lgAutoplay = o());
})(this, function () {
    'use strict';
    var t = function () {
            return (t =
                ...
                function (t) {
                    for (var o, e = 1, s = arguments.length; e < s; e++)
                        for (var r in (o = arguments[e])) Object.prototype.hasOwnProperty.call(o, r) && (t[r] = o[r]);
                    return t;
    ...
    return (function () {
        ...
        return (
            (p.prototype.init = function () {
                ...
                this.settings.autoplay &&
                    ...
                    this.core.LGel.on(e + '.autoplay', function () {
                        (t.showProgressBar(),
                            !t.fromAuto && t.interval ? (t.stopAutoPlay(), (t.pausedOnSlideChange = !0)) : (t.pausedOnSlideChange = !1),
                            (t.fromAuto = !1));
                    }),
            ...
            (p.prototype.destroy = function () {
                (this.settings.autoplay && this.core.outer.find('.lg-progress-bar').remove(),
