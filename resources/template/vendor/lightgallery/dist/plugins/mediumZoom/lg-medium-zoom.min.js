...
!(function (o, t) {
    'object' == typeof exports && 'undefined' != typeof module
        ...
        : 'function' == typeof define && define.amd
          ? define(t)
          : ((o = 'undefined' != typeof globalThis ? globalThis : o || self).lgMediumZoom = t());
})(this, function () {
    'use strict';
    var o = function () {
            return (o =
                ...
                function (o) {
                    for (var t, e = 1, i = arguments.length; e < i; e++)
                        for (var n in (t = arguments[e])) Object.prototype.hasOwnProperty.call(t, n) && (o[n] = t[n]);
                    return o;
                }).apply(this, arguments);
        },
        t = 'lgBeforeOpen',
        e = { margin: 40, mediumZoom: !0, backgroundColor: '#000' };
    return (function () {
        function i(t, i) {
            var n = this;
            ((this.core = t),
                ...
                (this.core.getMediaContainerPosition = function () {
                    return { top: n.settings.margin, bottom: n.settings.margin };
                }));
            var s = {
                controls: !1,
                download: !1,
            ...
            return ((this.core.settings = o(o({}, this.core.settings), s)), (this.settings = o(o(o({}, e), this.core.settings), s)), this);
        }
        return (
            (i.prototype.toggleItemClass = function () {
            ...
            (i.prototype.init = function () {
                ...
                this.settings.mediumZoom &&
                    (this.core.LGel.on(t + '.medium', function () {
