...
!(function (a) {
    ...
    function d(a, b, c) {
        return ((b = h(b)), b in a ? Object.defineProperty(a, b, { value: c, enumerable: !0, configurable: !0, writable: !0 }) : (a[b] = c), a);
    }
    function e(a, b) {
    ...
    function g(a, b, c) {
        return (b && f(a.prototype, b), c && f(a, c), Object.defineProperty(a, 'prototype', { writable: !1 }), a);
    }
    function h(a) {
        var b = i(a, 'string');
                ...
                g(a, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            var k = b || e || d;
                            if (
                                (k && (this.k = this._e2('div', { class: 'iti__flag-container' }, j)),
                                ...
                                e && (this.l = this._e2('div', { class: 'iti__flag' }, this.selectedFlag)),
                                this.selectedFlag && this.a.disabled && this.selectedFlag.setAttribute('aria-disabled', 'true'),
                                d && (this.t = this._e2('div', { class: 'iti__selected-dial-code' }, this.selectedFlag)),
                                b &&
                    ...
                    },
                    {
                        ...
                        value: function (a) {
                            var b = a,
                                c = this.s.dialCode,
                                d = '1' === c;
                            (b && d && '+' !== b.charAt(0) && ('1' !== b.charAt(0) && (b = '1'.concat(b)), (b = '+'.concat(b))),
                    ...
                    },
                    {
                        ...
                        value: function (a) {
                            ...
                            if (
                                ...
                                e && this.l.setAttribute('class', 'iti__flag iti__'.concat(a)),
                    ...
                    },
                    {
                        ...
                        value: function (a, b) {
                            if (this.selectedFlag) {
                                var c;
                                ((c = a && !b ? ''.concat(this.s.name, ': +').concat(this.s.dialCode) : a ? this.s.name : 'Unknown'),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            'auto' === this.d.initialCountry &&
                                ((this.j = window.intlTelInputGlobals.autoCountry), this.a.value || this.setCountry(this.j), this.h());
                        },
                    },
                    {
                        key: 'handleUtils',
        ...
        if ('string' == typeof c && '_' !== c[0]) {
            ...
            return (
                this.each(function () {
                    ...
                    (b instanceof s && 'function' == typeof b[c] && (e = b[c].apply(b, Array.prototype.slice.call(d, 1))),
