        ...
        _createClass(Iti, [
            ...
            },
            {
                ...
                value: function _handleUpDownKey(key) {
                    var next =
                        key === 'ArrowUp' || key === 'Up' ? this.highlightedItem.previousElementSibling : this.highlightedItem.nextElementSibling;
                    if (next) {
                        // skip the divider
            ...
            },
            {
                ...
                value: function _updatePlaceholder() {
                    var shouldSetPlaceholder =
                        this.options.autoPlaceholder === 'aggressive' || (!this.hadInitialPlaceholder && this.options.autoPlaceholder === 'polite');
