    ...
    !(function (T) {
        ...
        ((t = null),
            String.prototype.startsWith ||
                ...
                Object.defineProperty
                    ? Object.defineProperty(String.prototype, 'startsWith', { value: p, configurable: !0, writable: !0 })
        ...
        T.fn.triggerNative = function (e) {
            var t,
                i = this[0];
            i.dispatchEvent &&
                (f ? (t = new Event(e, { bubbles: !0 })) : (t = document.createEvent('Event')).initEvent(e, !0, !1), i.dispatchEvent(t));
        };
        var m = {
                '\xc0': 'A',
                '\xc1': 'A',
        ...
        var Q = new RegExp(M + '|' + R),
            ...
            Z = {
                ...
                text: function (e, t) {
                    ...
                    if (!0 === t) for (; 0 < n.childNodes.length; ) K.fragment.appendChild(n.childNodes[0]);
                ...
                label: function (e) {
                    ...
                    return (
                        e.subtext && (((t = K.subtext.cloneNode(!1)).textContent = e.subtext), s.appendChild(t)),
                        K.fragment.appendChild(s),
                        K.fragment
                    );
                },
        ...
        function X(e, t) {
            e.length ||
                ((K.noResults.innerHTML = this.options.noneResultsText.replace('{0}', '"' + E(t) + '"')),
        ...
        function ie(e) {
            ...
            if ('4' <= j.major) {
                ...
                (te.DEFAULTS.style === G.BUTTONCLASS && t.push({ name: 'style', className: 'BUTTONCLASS' }),
                    te.DEFAULTS.iconBase === G.ICONBASE && t.push({ name: 'iconBase', className: 'ICONBASE' }),
                    te.DEFAULTS.tickIcon === G.TICKICON && t.push({ name: 'tickIcon', className: 'TICKICON' }),
                ...
                if (e.is('select')) {
                    ...
                    if ((i.title && (i.placeholder = i.title), t)) {
                        ...
                        ((l.template = T.extend(
                            ...
                            T.fn.selectpicker.defaults ? T.fn.selectpicker.defaults.template : {},
                            n.template,
                            i.template,
                        )),
        ...
        ((te.VERSION = '1.14.0-beta2'),
            ...
            (te.prototype = {
                ...
                createDropdown: function () {
                    ...
                    return (
                        ...
                        this.options.allowClear &&
                            (c = '<span class="close bs-select-clear-selected" title="' + this.options.deselectAllText + '"><span>&times;</span>'),
                        (n =
                            ...
                            c +
                            '</span>' +
                            ('4' <= j.major ? '' : '<span class="bs-caret">' + this.options.template.caret + '</span>') +
                            '</button><div class="' +
                            G.MENU +
                            ' ' +
                            ('4' <= j.major ? '' : G.SHOW) +
                ...
                isVirtual: function () {
                    return (
                        (!1 !== this.options.virtualScroll && this.selectpicker.main.data.length >= this.options.virtualScroll) ||
                    ...
                    function W(e, t) {
                        ...
                        if (
                            ...
                            void 0 !== N.activeIndex &&
                                ((L = (N.selectpicker.main.data[N.prevActiveIndex] || {}).element),
                                (H = (N.selectpicker.main.data[N.activeIndex] || {}).element),
                                (D = (N.selectpicker.main.data[N.selectedIndex] || {}).element),
                                t && (N.activeIndex !== N.selectedIndex && N.defocusItem(H), (N.activeIndex = void 0)),
                            ...
                            if (
                                ...
                                (N.selectpicker.view.visibleElements =
                                    !1 === u
                                        ...
                                        : N.selectpicker.current.elements.slice(N.selectpicker.view.position0, N.selectpicker.view.position1)),
                                N.setOptionStatus(),
                                (z || (!1 === u && t)) &&
                                    (p = !(function (e, i) {
                                        return (
                                ...
                                for (var y = x.length; f < y; f++) {
                                    ...
                                    (N.options.sanitize &&
                                        ($ = E.lastChild) &&
                                        (S = N.selectpicker.current.data[f + N.selectpicker.view.position0]) &&
                                        S.content &&
                                        !S.sanitized &&
                                ...
                                if (
                                    (N.options.sanitize && k.length && P(k, N.options.whiteList, N.options.sanitizeFn),
                                    !0 === u
                                        ? ((v =
                                              0 === N.selectpicker.view.position0
                                                  ? 0
                                                  : N.selectpicker.current.data[N.selectpicker.view.position0 - 1].position),
                                          (g =
                    ...
                    if ((this.options.placeholder || this.options.allowClear) && !this.multiple) {
                        ...
                        (n &&
                            ...
                            (!n && 0 === this.selectpicker.view.titleOption.index) ||
                                i.insertBefore(this.selectpicker.view.titleOption, i.firstChild),
                            s && d
                                ? (i.selectedIndex = 0)
                        ...
                        if (o.length) {
                            ...
                            for (var c = 0, d = o.length; c < d; c++) {
                                ...
                                (0 === c && (r = (l = m.length - 1) + d),
                                    w(h, { headerIndex: l, lastIndex: r, optID: a.optID, optgroupClass: a.optgroupClass, disabled: i.disabled }));
                            }
                            n && b({ optID: v });
                        }
                    }
                    ...
                    function l(e, t) {
                        ...
                        switch (t.type) {
                            case 'divider':
                                ...
                                break;
                            case 'option':
                                (i = Z.li(Z.a(Z.text.call(n, t), t.optionClass, t.inlineStyle), '', t.optID)).firstChild &&
                                    (i.firstChild.id = n.selectId + '-' + t.index);
                                break;
                            case 'optgroup-label':
                        ...
                        ((t.element = i),
                            ...
                            t.icon && (s += 1),
                            o < s && ((o = s), (n.selectpicker.view.widestOption = e[e.length - 1])));
                    }
                    (!n.options.showTick && !n.multiple) ||
                        K.checkMark.parentNode ||
                        ((K.checkMark.className = this.options.iconBase + ' ' + n.options.tickIcon + ' check-mark'), K.a.appendChild(K.checkMark));
                ...
                render: function (e) {
                    ...
                    if (
                        ...
                        (this.multiple &&
                            ...
                            1 < l &&
                            ((1 < (t = this.options.selectedTextFormat.split('>')).length && l > t[1]) || (1 === t.length && 2 <= l)))
                    ) {
                        if (!n) {
                ...
                liHeight: function (e) {
                    if (e || (!1 !== this.options.size && !Object.keys(this.sizeInfo).length)) {
                        var t,
                            ...
                            d =
                                this.options.header && 0 < this.$menu.find('.' + G.POPOVERHEADER).length
                ...
                getSelectPosition: function () {
                    ...
                    this.options.container && s.length && !s.is('body')
                        ? (((e = s.offset()).top += parseInt(s.css('borderTopWidth'))), (e.left += parseInt(s.css('borderLeftWidth'))))
                        : (e = { top: 0, left: 0 });
                ...
                setSize: function (e) {
                    if ((this.liHeight(e), this.options.header && this.$menu.css('padding-top', 0), !1 !== this.options.size)) {
                        ...
                        (this.setMenuSize(),
                            ...
                            'auto' === this.options.size
                                ? i
                                      .off('resize' + F + '.' + this.selectId + '.setMenuSize scroll' + F + '.' + this.selectId + '.setMenuSize')
                                      .on(
                                ...
                                : this.options.size &&
                                  ...
                                  i.off('resize' + F + '.' + this.selectId + '.setMenuSize scroll' + F + '.' + this.selectId + '.setMenuSize'));
                    }
                ...
                selectPosition: function () {
                    ...
                    function e(e) {
                        ...
                        (l.$bsContainer.addClass(e.attr('class').replace(/form-control|fit-width/gi, '')).toggleClass(G.DROPUP, e.hasClass(G.DROPUP)),
                            ...
                            (j.major < 4 || 'static' === i) && ((t.top = s.top - n.top + o), (t.left = s.left - n.left)),
                    ...
                    (this.$button.on('click.bs.dropdown.data-api', function () {
                        ...
                        T(window)
                            .off('resize' + F + '.' + this.selectId + ' scroll' + F + '.' + this.selectId)
                            .on('resize' + F + '.' + this.selectId + ' scroll' + F + '.' + this.selectId, function () {
                ...
                setSelected: function (e, t) {
                    ...
                    o &&
                        ...
                        r ? (this.focusItem(o, e), (this.selectpicker.view.currentActive = o), (this.activeIndex = n)) : this.defocusItem(o),
                        s &&
                ...
                checkDisabled: function () {
                    this.isDisabled()
                        ? (this.$newElement[0].classList.add(G.DISABLED), this.$button.addClass(G.DISABLED).attr('aria-disabled', !0))
                        : this.$button[0].classList.contains(G.DISABLED) &&
                          (this.$newElement[0].classList.remove(G.DISABLED), this.$button.removeClass(G.DISABLED).attr('aria-disabled', !1));
                },
                    ...
                    (t.data('spaceSelect', !1),
                                    ...
                                    (t !== i && t.parentElement !== i) ||
                                        ...
                                        (function () {
                                            ...
                                            O.$newElement.hasClass(G.SHOW) &&
                                                (O.options.liveSearch && O.$searchbox.trigger('focus'), O.createView(!1));
                                        })()));
                            }
                        ...
                        this.$menuInner.on('click', 'li a', function (e, t) {
                            ...
                            if (
                                ...
                                if (
                                    (l === O.activeIndex && (t = !0),
                                    t || ((O.prevActiveIndex = O.activeIndex), (O.activeIndex = void 0)),
                                    O.multiple)
                                ) {
                                    if ((O.setSelected(o, !f), O.focusedParent.focus(), !1 !== g || !1 !== b)) {
                                        ...
                                        if ((g && w) || (b && I))
                                            if (g && 1 == g) ((s.selectedIndex = -1), (p.selected = !0), O.setOptionStatus(!0));
                                                ...
                                                ($[2] &&
                                                    ((S = S.replace('{var}', $[2][1 < g ? 0 : 1])), (E = E.replace('{var}', $[2][1 < b ? 0 : 1]))),
                                                    (p.selected = !1),
                                                    O.$menu.append(C),
                                                    g && w && (C.append(T('<div>' + S + '</div>')), (h = !1), O.$element.trigger('maxReached' + F)),
                                                    b &&
                                                        I &&
                                                        (C.append(T('<div>' + E + '</div>')), (h = !1), O.$element.trigger('maxReachedGrp' + F)),
                                                    setTimeout(function () {
                                                        O.setSelected(l, !1);
                                                    }, 10),
                                ...
                                (O.options.source.data && O.$element[0].appendChild(O.selectpicker.main.optionQueue),
                                    ...
                                    h &&
                                        ((!O.multiple && a === s.selectedIndex) ||
                                            ((D = [p.index, u.prop('selected'), r]), O.$element.triggerNative('change'))));
                            }
                        }),
                        this.$menu.on(
                            'click',
                            'li.' + G.DISABLED + ' a, .' + G.POPOVERHEADER + ', .' + G.POPOVERHEADER + ' :not(.close)',
                            function (e) {
                        ...
                        this.$button
                            ...
                            .on('blur' + F, function (e) {
                                void 0 !== O.selectpicker.view.tabindex &&
                                    e.originalEvent &&
                                    e.originalEvent.isTrusted &&
                                    (O.$element[0].setAttribute('tabindex', O.selectpicker.view.tabindex),
                                ...
                                if (u.options.source.search)
                                    ...
                                    for (var r = 0; r < u.selectpicker.main.data.length; r++) {
                                        ...
                                        (s[r] || (s[r] = k(a, i, o, l)),
                                            s[r] &&
                                                ...
                                                (0 < a.headerIndex && ((s[a.headerIndex - 1] = !0), n.push(a.headerIndex - 1)),
                                                (s[a.headerIndex] = !0),
                                    ...
                                    for (var c = n.length; r < c; r++) {
                                        ...
                                        ('divider' !== a.type || ('divider' === a.type && p && 'divider' !== p.type && c - 1 !== r)) &&
                                            (u.selectpicker.search.data.push(a), e.push(u.selectpicker.main.elements[d]));
                                    }
                ...
                changeAll: function (e) {
                    if (this.multiple) {
                        ...
                        (t.classList.remove('bs-select-hidden'),
                            i !== s && (this.setOptionStatus(), (D = [null, null, n]), this.$element.triggerNative('change')));
                    }
                },
                selectAll: function () {
                ...
                toggle: function (e, t) {
                    ...
                    ((e = e || window.event) && e.stopPropagation(),
                        !1 === s && ((i = this.$newElement[0].classList.contains(G.SHOW)), (s = (!0 === t && !1 === i) || (!1 === t && !0 === i))),
                        ...
                        if (
                                    ...
                                    e.which === M
                                        ? (-1 !== t && t--,
                                          ...
                                          a.selectpicker.view.canHighlight[t + f] ||
                                              (-1 === (t = a.selectpicker.view.canHighlight.slice(0, t + f).lastIndexOf(!0) - f) &&
                                                  (t = c.length - 1)))
                                        : (e.which !== R && !h) ||
                                          (++t + f >= a.selectpicker.view.canHighlight.length && (t = a.selectpicker.view.firstHighlightIndex),
                                          a.selectpicker.view.canHighlight[t + f] ||
                                              (t = t + 1 + a.selectpicker.view.canHighlight.slice(t + f + 1).indexOf(!0))),
                                    e.preventDefault());
                                var m = f + t;
                                (e.which === M
                                    ? 0 === f && t === c.length - 1
                                    ...
                                    (c.removeClass('active').find('a').removeClass('active'),
                                        ...
                                        (d =
                                            0 < u - (n = a.selectpicker.main.data[v]).position
                                                ...
                                                : ((o = n.position - a.sizeInfo.menuInnerHeight), n.position > u + a.sizeInfo.menuInnerHeight)),
                            ...
                            i &&
                                ...
                                (a.options.liveSearch && e.which === W) ||
                                    ...
                                    l.trigger('focus'),
                                    a.options.liveSearch || (e.preventDefault(), T(document).data('spaceSelect', !0))));
                        }
                },
                mobile: function () {
        ...
        function ne() {
            return j.major < 5
                ? T.fn.dropdown
                    ? (T.fn.dropdown.Constructor._dataApiKeydownHandler || T.fn.dropdown.Constructor.prototype.keydown).apply(this, arguments)
                    : void 0
        ...
        ((T.fn.selectpicker = ie),
            ...
            T(document)
                ...
                .on('keydown.bs.dropdown.data-api', ':not(.bootstrap-select) > [' + q.DATA_TOGGLE + ']', ne)
                .on('keydown.bs.dropdown.data-api', ':not(.bootstrap-select) > .dropdown-menu', ne)
                .on(
                    'keydown' + F,
                    '.bootstrap-select [' + q.DATA_TOGGLE + '], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input',
