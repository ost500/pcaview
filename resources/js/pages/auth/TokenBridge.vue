            ...
            <div class="bg-white px-4 py-8 shadow sm:rounded-lg sm:px-10">
                <div class="text-center">
                    ...
                    <div v-if="status === 'sent'" class="space-y-4">
                        ...
                        <p class="mt-2 text-xs text-gray-400">잠시 후 자동으로 이동합니다...</p>
                    </div>

                    <!-- Error State -->
                    <div v-if="status === 'error'" class="space-y-4">
                        <div class="inline-flex h-16 w-16 items-center justify-center rounded-full bg-red-100">
                    ...
                    <!-- User Info -->
                    <div v-if="status === 'sent'" class="mt-6 border-t border-gray-200 pt-6">
                    ...
                    <div v-if="isDev" class="mt-6 border-t border-gray-200 pt-6">
                        <details class="text-left">
                            <summary class="cursor-pointer text-xs text-gray-500">디버그 정보</summary>
                            <pre class="mt-2 overflow-auto rounded bg-gray-100 p-2 text-left text-xs">{{
                                {
