        ...
        <div class="container">
            ...
            <div class="space-y-6">
                ...
                <section class="space-y-3">
                    ...
                    <p class="text-muted-foreground">
                        서비스는 이용자의 개인정보를 회원 가입일로부터 서비스를 제공하는 기간 동안
                        보유 및 이용합니다. 회원 탈퇴 시 지체없이 파기합니다.
                    </p>
                    <p class="text-muted-foreground">
                        단, 관련 법령에 의해 보존할 필요가 있는 경우 해당 법령에서 정한 기간 동안
                        보관합니다:
                    </p>
                    <ul class="ml-6 list-disc space-y-2 text-muted-foreground">
                        <li>
                ...
                <section class="space-y-3">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full border-collapse border border-sidebar-border">
                            ...
                            <tbody>
                                <tr>
                                    <td class="border border-sidebar-border p-3 text-muted-foreground">
                ...
                <section class="space-y-3">
                    ...
                    <p class="text-muted-foreground">
                        위 권리 행사는 서비스의 '설정 &gt; 프로필' 메뉴를 통해 직접 하실 수
                        있습니다.
                    </p>
                </section>
                ...
                <section class="space-y-3">
                    ...
                    <p class="text-muted-foreground">
                        서비스는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게
                ...
                <section class="space-y-3">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-muted-foreground">
                            ...
                            이용자가 웹사이트에 접속할 때 컴퓨터는 이용자의 브라우저에 있는 쿠키의
                            내용을 읽고, 추가정보를 찾아 서비스를 제공합니다.
                        </p>
                    </div>
                    <div class="space-y-2">
