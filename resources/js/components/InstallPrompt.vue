...
import { Download, EyeOff, X } from 'lucide-vue-next';
            ...
            >
                <div v-if="props.showInstallPrompt" class="relative w-full max-w-md overflow-hidden rounded-3xl bg-white shadow-2xl">
                    ...
                    <div class="flex flex-col gap-2 px-6 pb-6">
                        <button
                            @click="handleInstall"
                            class="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 px-4 py-3.5 font-semibold text-white transition-transform hover:scale-[1.02] active:scale-[0.98]"
                        >
                            <Download :size="18" />
                        ...
                        <div class="flex gap-2">
                            <button
                                @click="handleDismiss"
                                class="flex-1 rounded-xl bg-gray-100 px-4 py-3 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-200"
                            >
                                나중에
                            </button>
                            <button
                                @click="handleDismissPermanently"
                                class="flex flex-1 items-center justify-center gap-1 rounded-xl bg-gray-100 px-4 py-3 text-sm font-medium text-gray-500 transition-colors hover:bg-gray-200"
                            >
                                <EyeOff :size="14" />
                                보지않기
                            </button>
