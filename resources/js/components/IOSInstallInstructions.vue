...
import { Command, Home, Plus, Share, Star } from 'lucide-vue-next';
            ...
            >
                <div v-if="props.showIOSInstructions" class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content" style="border-radius: 1.5rem; border: none; overflow: hidden; max-height: 90vh; overflow-y: auto">
                        ...
                        <div
                            class="modal-header"
                            style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none; padding: 2rem 1.5rem 1.5rem"
                        >
                            <div class="w-100 text-center">
                                ...
                                <h5 class="modal-title fw-bold mb-1 text-white" style="font-size: 1.5rem">설치 방법 안내</h5>
                            ...
                            <button
                                ...
                                style="top: 1rem; right: 1rem; opacity: 0.8"
                                aria-label="닫기"
                            ></button>
                        </div>
                        ...
                        <div class="modal-body" style="padding: 1.5rem">
                            ...
                            <template v-if="props.isIOS">
                                <p class="mb-4 text-muted" style="font-size: 0.875rem">
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            ...
                                            <div class="ms-3 flex-grow-1">
                                                <div class="d-flex align-items-center mb-1">
                                                    ...
                                                    <h6 class="fw-semibold mb-0" style="font-size: 0.875rem">공유 버튼 누르기</h6>
                                                </div>
                                                <p class="mb-0 text-muted" style="font-size: 0.75rem">
                                                    Safari 하단의 공유 버튼(상자에서 화살표)을 누르세요
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            ...
                                            <div class="ms-3 flex-grow-1">
                                                <div class="d-flex align-items-center mb-1">
                                                    ...
                                                    <h6 class="fw-semibold mb-0" style="font-size: 0.875rem">"홈 화면에 추가" 선택</h6>
                                                </div>
                                                <p class="mb-0 text-muted" style="font-size: 0.75rem">
                                                    아래로 스크롤하여 "홈 화면에 추가"를 찾아 누르세요
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="ms-3 flex-grow-1">
                                                <div class="d-flex align-items-center mb-1">
                                                    ...
                                                    <h6 class="fw-semibold mb-0" style="font-size: 0.875rem">추가 버튼 누르기</h6>
                                                </div>
                                ...
                                <div
                                    ...
                                    style="background: linear-gradient(135deg, #d4fc79 0%, #96e6a1 100%); border: none; border-radius: 1rem"
                                >
                            ...
                            <template v-else>
                                ...
                                <div class="card mb-3" style="border: 2px solid #f0f0f0; border-radius: 1rem; background: #fafafa">
                                    <div class="card-body p-3">
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div class="ms-3 flex-grow-1">
                                                <h6 class="fw-semibold mb-0" style="font-size: 0.875rem">Chrome / Edge</h6>
                                                <p class="mb-0 text-muted" style="font-size: 0.75rem">
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div class="ms-3 flex-grow-1">
                                                <h6 class="fw-semibold mb-0" style="font-size: 0.875rem">Safari</h6>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3 flex-grow-1">
                                                <h6 class="fw-semibold mb-0" style="font-size: 0.875rem">단축키</h6>
                                                <p class="mb-0 text-muted" style="font-size: 0.75rem">
                                ...
                                <div
                                    ...
                                    style="background: linear-gradient(135deg, #84fab0 0%, #8fd3f4 100%); border: none; border-radius: 1rem"
                                >
                                    <p class="mb-0" style="font-size: 0.875rem">✨ 즐겨찾기에서 명성교회 주보고를 빠르게 찾을 수 있습니다!</p>
                                </div>
                            </template>
                        </div>
                        ...
                        <div class="modal-footer" style="border: none; padding: 0 1.5rem 1.5rem; gap: 0.5rem">
                            ...
                            <button
                                ...
                                style="border-radius: 10px; padding: 0.75rem; font-size: 0.875rem"
                            >
                                다시 보지 않기
                            </button>
                        </div>
