...
import { Command, Home, Plus, Share, Star, X } from 'lucide-vue-next';
        ...
        >
            ...
            >
                <div v-if="props.showIOSInstructions" class="relative max-h-[90vh] w-full max-w-md overflow-y-auto rounded-3xl bg-white shadow-2xl">
                    <!-- 헤더 -->
                    <div class="bg-gradient-to-br from-blue-600 to-purple-600 px-6 pt-8 pb-6 text-center">
                        <!-- 앱 아이콘 -->
                        ...
                        <button
                            ...
                            class="absolute top-4 right-4 rounded-full p-2 text-white/80 transition-colors hover:bg-white/20"
                            aria-label="닫기"
                        >
                            <X :size="20" />
                        </button>
                    ...
                    <div class="p-6">
                        ...
                        <template v-if="props.isAndroid">
                            <p class="mb-4 text-sm text-gray-600">Play Store에서 주보고 앱을 다운로드하여 더 나은 경험을 즐기세요.</p>
                            ...
                            <div class="mb-4 rounded-2xl border-2 border-gray-100 bg-gray-50 p-4">
                                ...
                                <div class="mb-4 flex items-start">
                                    <div
                                        class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-blue-600 to-purple-600 text-sm font-bold text-white"
                                    >
                                        1
                                    </div>
                                ...
                                <div class="flex items-start">
                                    <div
                                        class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-pink-500 to-red-500 text-sm font-bold text-white"
                                    >
                                        2
                                    </div>
                                    <div class="ml-3 flex-grow">
                            ...
                            <div class="rounded-2xl bg-gradient-to-r from-green-400 to-emerald-500 p-4">
                                <p class="text-sm text-white">✨ Play Store에서 설치하면 자동 업데이트와 안정적인 성능을 제공받을 수 있습니다!</p>
                            </div>
                        </template>

                        <!-- iOS 안내 -->
                        <template v-else-if="props.isIOS">
                            <p class="mb-4 text-sm text-gray-600">Safari에서 주보고를 홈 화면에 추가하면 앱처럼 빠르게 이용할 수 있습니다.</p>
                            ...
                            <div class="mb-4 rounded-2xl border-2 border-gray-100 bg-gray-50 p-4">
                                ...
                                <div class="flex items-start">
                                    <div
                                        class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-cyan-400 to-blue-500 text-sm font-bold text-white"
                                    >
                                        3
                                    </div>
                                    <div class="ml-3 flex-grow">
                            ...
                            <!-- iOS 결과 안내 -->
                            <div class="rounded-2xl bg-gradient-to-r from-green-400 to-emerald-500 p-4">
                                <p class="text-sm text-white">✨ 홈 화면에 주보고 아이콘이 생기고, 앱처럼 빠르게 실행할 수 있습니다!</p>
                            </div>
                        </template>

                        <!-- 데스크톱 안내 -->
                        <template v-else>
                            <p class="mb-4 text-sm text-gray-600">주보고를 즐겨찾기에 추가하면 더욱 빠르게 접속할 수 있습니다.</p>
                            ...
                            <div class="mb-4 rounded-2xl border-2 border-gray-100 bg-gray-50 p-4">
                                ...
                                <div class="mb-4 flex items-center">
                                    <div
                                        class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 to-purple-600"
                                    >
                                ...
                                <div class="mb-4 flex items-center">
                                    <div
                                        class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-pink-500 to-red-500"
                                    >
                                ...
                                <div class="flex items-center">
                                    <div
                                        class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-400 to-blue-500"
                                    >
                            ...
                            <div class="rounded-2xl bg-gradient-to-r from-emerald-400 to-cyan-500 p-4">
                                <p class="text-sm text-white">✨ 즐겨찾기에서 주보고를 빠르게 찾을 수 있습니다!</p>
                            </div>
                        </template>
                    </div>
                    ...
                    <div class="flex flex-col gap-2 px-6 pb-6">
                        <button
                            @click="closeIOSInstructions"
                            class="w-full rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 px-4 py-3.5 font-semibold text-white transition-transform hover:scale-[1.02] active:scale-[0.98]"
                        >
                            확인했습니다
                        </button>
                        <button
                            @click="dismissPermanently"
                            class="w-full rounded-xl bg-gray-100 px-4 py-3 text-sm font-medium text-gray-500 transition-colors hover:bg-gray-200"
                        >
                            다시 보지 않기
                        </button>
                    </div>
